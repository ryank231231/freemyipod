#ifndef __TARGET_UMSBOOT_IPODCLASSIC_TARGET_H__
#define __TARGET_UMSBOOT_IPODCLASSIC_TARGET_H__

#include "board/ipodclassic/target.h"
...
#define RAMDISK_PTR_ADDR 0x2203fffc
